package com.myweatherapp.screens.search
...
import com.myweatherapp.WeatherApp
...
fun SearchBar(modifier: Modifier, onSearch: (String) -> Unit = {}) {
    ...
    val valid = remember(searchQueryState.value) {
        //returns true or false if search query is empty or not
    ...
    Column() {
        CommonTextField(
            ...
            onAction = KeyboardActions {
                if(!valid) return@KeyboardActions else onSearch(searchQueryState.value.trim())
